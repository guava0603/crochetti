...
const router = createRouter({
  ...
  routes: [
    ...
    },
    {
      ...
      meta: { bannerTitleKey: 'auth.login', bannerShowBack: true, requiresAuth: false, footer: 'action' },
    },
    {
      path: '/about',
      name: 'about',
    ...
    },
    {
      ...
      meta: { requiresAuth: true, footer: 'action' },
    },
    {
      path: '/add-project',
      name: 'add-project',
    ...
    },
    {
      ...
      meta: { bannerTitleKey: 'record.record', requiresAuth: true, footer: 'bar' },
    },
    {
...

    {
      ...
      meta: { bannerTitleKey: 'wishPool.title', requiresAuth: true, footer: 'action' },
    },
