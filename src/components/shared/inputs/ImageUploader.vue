...
import ButtonUploadImage from '@/components/shared/buttons/svg/ButtonUploadImage.vue'
import ButtonDeleteLight from '@/components/shared/buttons/ButtonDeleteLight.vue'
