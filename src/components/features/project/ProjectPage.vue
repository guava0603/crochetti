...
import ButtonStar from '@/components/shared/buttons/svg/ButtonStar.vue'
import ComponentCard from '@/components/features/project/component-card/index.vue'
import ImageGroup from '@/components/shared/carousel/ImageGroup.vue'
import CarouselWithDot from '@/components/shared/carousel/CarouselWithDot.vue'
import BottomSheetScroll from '@/components/shell/layout/BottomSheetScroll.vue'
import RecordSelectionModal from '@/components/modals/record/RecordSelectionModal.vue'
