<template>
  <div
    ...
    :class="{
      ...
      'record-result-view--static': disableAnimations,
      'record-result-view--sharing': isSharingLayout
    }"
  >
...
.record-result-view--sharing {
  width: 100%;
  max-width: 100%;
  min-width: 0;
}

.record-result-view--sharing .page-content {
  width: 100%;
  max-width: 100%;
  min-width: 0;
...
.result-body--sharing .result-summary {
  grid-template-columns: 1fr;
}

.result-body--sharing .top-badge__title {
  min-width: 0;
  white-space: normal;
